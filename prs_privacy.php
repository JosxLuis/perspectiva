...
<html lang="es-MX">
<head>
	<title>Privacidad - <?php echo PROYECTO; ?></title>
	<meta charset="UTF-8">
...
<?php include(PREFIJO.'header.php'); ?>
	...
	<div class="headline3 sec-third-color ">
        <div class="container">
            <div class="sixteen columns">
                <div class="box pd-60">
                    <h3 class="lt-bold col-third">Aviso de privacidad</h3>
                </div>
            </div>
        </div>
	</div>
	...
	<div class="section pd-30">
		<div class="box tx-jus ">
			<div class="container">
				<div class="sixteen columns">
					<div class="box">
						<h3 class="lt-bold">Aviso de privacidad</h3>
						<p class="lt-reg">
							<?php echo PROYECTO; ?>
							<br>
							De conformidad con lo dispuesto en la Ley Federal de Protección de Datos Personales en Posesión de los Particulares y en su Reglamento, hace de su conocimiento que es responsable de recabar sus datos personales, del uso que se les dé a los mismos y de su protección. Su información personal será utilizada para proveerle de los servicios de productos de limpieza que nos ha solicitado, informarle sobre condiciones y cambios en los mismos y evaluar la calidad del servicio que le prestamos.<br><br>

							Para las finalidades antes mencionadas requerimos obtener sus siguientes datos personales:<br><br>
							• Nombre<br>
							• Domicilio<br>
							• Teléfono<br>
							...
							Recabamos sus datos personales para los efectos mencionados en presente Aviso de Privacidad. <br><br>

							En este sentido, hacemos de su conocimiento que sus datos personales serán tratados y resguardados con base en los principios de licitud, calidad, consentimiento, información, finalidad, lealtad, proporcionalidad y responsabilidad, consagrados en la Ley Federal de Protección de Datos Personales en Posesión de Particulares y su Reglamento.<br><br>

							Finalidad en el tratamiento de sus datos personales: <br><br>

							Recopilamos sus datos personales, por lo que solicitamos su consentimiento a través del presente Aviso de Privacidad con el objeto de utilizarlos para los siguientes fines:<br><br>

							1. Identificarlo como cliente y prestarle los servicios contratados con nosotros<br>
							2. Para contactarlo y enviarle información relevante respecto de temas de nuestros servicios.<br><br>

							Medios para limitar el uso o divulgación de sus datos personales:<br><br>

							Hacemos de su conocimiento que sus datos personales serán resguardados bajo estrictas medidas de seguridad administrativas, técnicas y físicas las cuales han sido implementadas con el objeto de proteger sus datos personales contra daño, pérdida, alteración, destrucción o el uso, acceso o tratamiento no autorizados. <br><br>

							Medios para el ejercicio de sus derechos como titular de los datos personales:<br><br>
							...
							No seremos responsables en caso de que usted no reciba la referida notificación de cambio en el Aviso de Privacidad por causa de algún problema con su cuenta de correo electrónico o de transmisión de datos por internet. <br><br>
