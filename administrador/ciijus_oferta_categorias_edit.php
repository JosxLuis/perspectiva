<?php
	if(isset($_POST['eliminar-foto']) && $_POST['eliminar-foto'] != ""){
		$portada = devolverValorQuery("SELECT portada FROM ".DB_PREFIJO."oferta_categoria WHERE id".DB_PREFIJO."oferta_categoria=".$_GET['id']." ");
		if($portada['portada'] != ""){
    		unlink("../".$portada['portada']);
		}
		$borrarEntrada = "UPDATE ".DB_PREFIJO."oferta_categoria SET portada = '' WHERE id".DB_PREFIJO."oferta_categoria= ".$_GET['id']."";
	...
	if(isset($_POST['titulo']) && $_POST['titulo'] != ""){
		...
		$editarRegistro = "UPDATE ".DB_PREFIJO."oferta_categoria SET $fotografia titulo='".utf8_decode($_POST['titulo'])."',descripcion='".utf8_decode($_POST['descripcion'])."', icono='".utf8_decode($_POST['icono'])."' WHERE id".DB_PREFIJO."oferta_categoria=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."oferta_categoria WHERE id".DB_PREFIJO."oferta_categoria=".$_GET['id']." ");
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
							...
							<input type="text" name="icono" value="<?php echo utf8_encode($consulta['icono']); ?>">
