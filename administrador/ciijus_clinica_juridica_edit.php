<?php
	if(isset($_POST['eliminar-foto']) && $_POST['eliminar-foto'] != ""){
		...
		$borrarEntrada = "UPDATE ".DB_PREFIJO."clinica SET portada = '' WHERE id".DB_PREFIJO."clinica= ".$_GET['id']."";
	...
	if(isset($_POST['titulo']) && $_POST['titulo'] != ""){
		...
		$editarRegistro = "UPDATE ".DB_PREFIJO."clinica SET $fotografia titulo='".utf8_decode(addslashes($_POST['titulo']))."',descripcion='".utf8_decode(addslashes($_POST['descripcion']))."' WHERE id".DB_PREFIJO."clinica=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."clinica WHERE id".DB_PREFIJO."clinica=".$_GET['id']." ");
