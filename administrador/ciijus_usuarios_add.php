<?php
	if(isset($_POST['editar']) && $_POST['nombre'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."administrador(id".DB_PREFIJO."administrador,id".DB_PREFIJO."administrador_rol,username,token,email,name,lastname,phone,address,active,procedence,creaded) VALUES (0,".$_POST['tipoUsuario'].",
		'".utf8_decode($_POST['correo'])."','".$_POST['usuario']."','".md5($password)."','".$ruta_image_normal."','".utf8_decode($_POST['nombre'])."','".utf8_decode($_POST['apellidos'])."','".utf8_decode($_POST['telefono'])."','".$fecha."')";
