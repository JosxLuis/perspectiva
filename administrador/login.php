...
if(isset($_POST['usuario']))
{
    ...
    $consulta = devolverValorQuery("SELECT id".DB_PREFIJO."administrador,usuario,passwd,id".DB_PREFIJO."administrador_rol FROM ".DB_PREFIJO."administrador WHERE (usuario='".$_POST['usuario']."' OR correo='".$_POST['correo']."') and passwd='".md5($password)."'");
