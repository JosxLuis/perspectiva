<?php
	if(isset($_POST['insertar']) && $_POST['descripcion'] != ""){
		...
		if (strlen($error)==0){			
			...
			$guardarPublicacion = "INSERT INTO ".DB_PREFIJO."acerca(id".DB_PREFIJO."acerca,id".DB_PREFIJO."administrador,portada,titulo,descripcion,creado)
	...
	if(isset($_POST['editar']) && $_POST['descripcion'] != ""){
		...
		if($_FILES['imagen']['name'] != null){
			...
			if (strlen($error)==0){			
				...
				$nombreImagenActual = devolverValorQuery("SELECT portada FROM ".DB_PREFIJO."acerca WHERE id".DB_PREFIJO."acerca=1");
		...
		$editarPublicacion = "UPDATE ".DB_PREFIJO."acerca SET $fotografia titulo='".utf8_decode(addslashes($_POST['titulo']))."' , descripcion = '".utf8_decode(addslashes($_POST['descripcion']))."' WHERE id".DB_PREFIJO."acerca=1";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."acerca WHERE id".DB_PREFIJO."acerca=1");
?>
<!DOCTYPE HTML>
<html lang="es-MX">
<head>
		...
		<div class="container">
			<div class="twelve columns">
				<div class="list-items">
					<div class="titulo">
						<h4>Acerca de <?php echo PROYECTO; ?></h4>
					</div>
						<div class="form-add">
