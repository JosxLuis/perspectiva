<?php
	if(isset($_POST['nombre']) && $_POST['nombre'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."coloquium(id".DB_PREFIJO."coloquium,id".DB_PREFIJO."administrador,portada,nombre,codigo,creado) 
		VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",'".$fotografia."','".utf8_decode(addslashes($_POST['nombre']))."','".utf8_decode(addslashes($_POST['codigo']))."','".$fecha."')";
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="nombre" placeholder="Nombre del coloquium"  required>
			        		<label for="codigo">Codigo</label>
			        		<textarea  name="codigo" placeholder="Codigo"></textarea>
