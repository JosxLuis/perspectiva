<?php
	if(isset($_POST['post_categoria']) && $_POST['post_categoria'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."post(id".DB_PREFIJO."post,id".DB_PREFIJO."administrador,id".DB_PREFIJO."post_categoria,portada,titulo,introduccion,descripcion,status,autor,creado) 
		VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",".$_POST['post_categoria'].",'".$fotografia."','".utf8_decode(addslashes($_POST['titulo']))."','".utf8_decode(addslashes($_POST['introduccion']))."','".utf8_decode(addslashes($_POST['descripcion']))."','".$status."','".$autor."','".$fecha."')";
