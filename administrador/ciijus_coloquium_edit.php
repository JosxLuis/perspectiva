<?php
	if(isset($_POST['eliminar-foto']) && $_POST['eliminar-foto'] != ""){
		...
		$borrarEntrada = "UPDATE ".DB_PREFIJO."coloquium SET portada = '' WHERE id".DB_PREFIJO."coloquium= ".$_GET['id']."";
	...
	if(isset($_POST['nombre']) && $_POST['nombre'] != ""){
		...
		$editarRegistro = "UPDATE ".DB_PREFIJO."coloquium SET $fotografia nombre='".utf8_decode(addslashes($_POST['nombre']))."',codigo='".utf8_decode(addslashes($_POST['codigo']))."' WHERE id".DB_PREFIJO."coloquium=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."coloquium WHERE id".DB_PREFIJO."coloquium=".$_GET['id']." ");
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="nombre" placeholder="Nombre del coloquium" value="<?php echo utf8_encode($consulta['nombre']); ?>" required>
			        		<label for="codigo">Codigo</label>
			        		<textarea  name="codigo"  placeholder="Codigo"><?php echo utf8_encode($consulta['codigo']); ?></textarea>
