<?php
	if(isset($_POST['titulo']) && $_POST['titulo'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."oferta_categoria(id".DB_PREFIJO."oferta_categoria,id".DB_PREFIJO."administrador,portada,titulo,descripcion,icono,creado) 
		VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",'".$fotografia."','".utf8_decode($_POST['titulo'])."','".utf8_decode($_POST['descripcion'])."','".utf8_decode($_POST['icono'])."','".$fecha."')";
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
							...
							<input type="text" name="icono" value="" placeholder="Ej. fa fa-icon-user">
