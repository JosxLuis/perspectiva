<?php
	if(isset($_POST['eliminar-foto']) && $_POST['eliminar-foto'] != ""){
		$portada = devolverValorQuery("SELECT portada FROM ".DB_PREFIJO."acuerdo WHERE id".DB_PREFIJO."acuerdo=".$_GET['id']." ");
		if($portada['portada'] != ""){
    		unlink("../".$portada['portada']);
		}
		$borrarEntrada = "UPDATE ".DB_PREFIJO."acuerdo SET portada = '' WHERE id".DB_PREFIJO."acuerdo= ".$_GET['id']."";
	...
	if(isset($_POST['titulo']) && $_POST['titulo'] != ""){
		...
		$editarRegistro = "UPDATE ".DB_PREFIJO."acuerdo SET $fotografia titulo='".utf8_decode(addslashes($_POST['titulo']))."',url='".utf8_decode(addslashes($_POST['url']))."' WHERE id".DB_PREFIJO."acuerdo=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."acuerdo WHERE id".DB_PREFIJO."acuerdo=".$_GET['id']." ");
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="titulo" placeholder="Titutlo del acuerdo" value="<?php echo utf8_encode($consulta['titulo']); ?>" maxlength="200" required>
			        		<label for="url">Url <span>*</span></label>
			        		<input type="text" name="url" placeholder="Url del acuerdo" value="<?php echo utf8_encode($consulta['url']); ?>" maxlength="200" required>
