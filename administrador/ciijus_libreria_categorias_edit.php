<?php
	if(isset($_POST['editar']) && $_POST['titulo'] != ""){
		...
		$editarRegistro = "UPDATE ".DB_PREFIJO."libro_categoria SET titulo='".utf8_decode($_POST['titulo'])."',descripcion='".utf8_decode($_POST['descripcion'])."' WHERE id".DB_PREFIJO."libro_categoria=".$_GET['id']." ";
	...
	$consulta = devolverValorQuery("SELECT * FROM ".DB_PREFIJO."libro_categoria WHERE id".DB_PREFIJO."libro_categoria=".$_GET['id']." ");
