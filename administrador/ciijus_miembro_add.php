<?php
	if(isset($_POST['puesto']) && $_POST['puesto'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."miembro(id".DB_PREFIJO."miembro,id".DB_PREFIJO."administrador,portada,nombre,puesto,origen,creado) 
		VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",'".$fotografia."','".utf8_decode(addslashes($_POST['nombre']))."','".utf8_decode(addslashes($_POST['puesto']))."','".utf8_decode(addslashes($_POST['origen']))."','".$fecha."')";
...
<head>
	<meta charset="UTF-8">
	<title>Miembros - Crear <?php echo PROYECTO; ?></title>
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="puesto" placeholder="Máx 200 caractéres" maxlength="200"  required>
			        		<label for="condicion">Origen</label>
			        		<input type="text" name="origen" placeholder="Máx 200 caractéres" maxlength="200"  required>
