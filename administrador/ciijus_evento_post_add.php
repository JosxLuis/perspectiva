<?php
	if(isset($_POST['titulo']) && $_POST['titulo'] != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."evento(id".DB_PREFIJO."evento,id".DB_PREFIJO."administrador,id".DB_PREFIJO."evento_lenguaje,portada,titulo,introduccion,descripcion,fecha,status,costo,consumo,creado) 
		VALUES (0,".$_SESSION[PREFIJO.'idadmin'].",".$_POST['lenguaje'].",'".$fotografia."','".utf8_decode(addslashes($_POST['titulo']))."','".utf8_decode(addslashes($_POST['introduccion']))."','".utf8_decode(addslashes($_POST['descripcion']))."','".utf8_decode($_POST['fecha'])."','".$status."','".utf8_decode(addslashes($_POST['costo']))."','".utf8_decode(addslashes($_POST['consumo']))."','".$fecha."')";
...
<head>
	<meta charset="UTF-8">
	<title>Evento - Crear <?php echo PROYECTO; ?></title>
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="fecha" readonly="readonly" placeholder="YYYY-MM-DD" required class="default_datetimepicker">
			        		<label for="costo">Costo <span>*</span></label>
			        		<input type="text" name="costo" placeholder="precio del costo"  required>
			        		<label for="consumo">Consumo <span>*</span></label>
			        		<input type="text" name="consumo" placeholder="precio del consumo"  required>
			    			<label for="requerido" class="req"><span>*</span> campos requeridos</label>
			        		<input type="submit" name="insertar" value="Publicar"> ó
