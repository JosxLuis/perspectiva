<?php
	if(isset($_POST['agregar']) != ""){
		...
		$insertarRegistro = "INSERT INTO ".DB_PREFIJO."versiones(id".DB_PREFIJO."versiones,id".DB_PREFIJO."administrador,version,introduccion,descripcion,fecha,creado) VALUES 
		(0,".$_SESSION[PREFIJO.'idadmin'].",'".utf8_decode($_POST['version'])."','".utf8_decode($_POST['introduccion'])."','".utf8_decode($_POST['descripcion'])."','".utf8_decode($_POST['fecha'])."','".$fecha."')";
				...
				<div class="list-items">
			        ...
			        <div class="form-add">
			        	<form name="form1" action="" method="post" enctype="multipart/form-data">
			        		...
			        		<input type="text" name="version" value="" required>
			        		<label for="condicion">Introducción</label>
			        		<input type="text" name="introduccion" required>
			        		<label for="descripcion">Descripcion</label>
			        		<textarea  name="descripcion" id="editor" placeholder="Descripción"></textarea>
			        		<label for="condicion">fecha</label>
			        		<input type="text" name="fecha" value=""  required class="default_datetimepicker" readonly="readonly">
