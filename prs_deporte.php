...
<head>
    <meta charset="UTF-8">
    <title>Deporte - <?php echo PROYECTO; ?></title>
...
<?php include(PREFIJO.'header.php'); ?>
    ...
    <div class="headline5 sec-third-color ">
        <div class="container">
            <div class="sixteen columns">
                <div class="box pd-60">
                    <h3 class="pp-semibol col-white">Deporte</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="noticias">
        <div class="container">
            <div class="two-thirds column">
                <div class="noticia">
                    <div class="portada">
                        <a href="<?php echo URL; ?>post/"><img src="../img/deporte.jpg" alt=""></a>
                    </div>
                    <div class="box">
                        <div class="status">
